    ...
    tabItems(
      ...
      tabItem(tabName = "lib_meta",
              fluidPage(
                tags$head(tags$style('
                        ...
                        ')), # This code prevents the dropdown menus from becoming unworkably narrow
                fluidRow(
      ...
      tabItem(tabName = "create_an_input",
              fluidPage(
                list(tags$head(tags$style(HTML("
                               ...
                               ")) # This code is to make the column seection check boxes more space efficient
                )),
                fluidRow(
                  box(title = "Column selection", width = 12, status = "primary", solidHeader = T, collapsible = T, collapsed = T,
                      tags$div(align = 'left', 
                               ...
                               checkboxGroupInput("input_create_an_show_vars", "Columns to show:",
                                                  choices = NULL, selected = NULL, inline = F)),
                      br(),
      ...
      tabItem(tabName = "completed_an",
              fluidPage(
                ...
                br(),
                selectInput("input_completed_analyses", "Choose a res ID", NULL),
                fluidRow(
                ...
                fluidRow(
                  box(title = "Single compound", width = 12, status = "primary", solidHeader = T, collapsible = T,
                      fluidRow(
                        ...
                        ')), # This code records the width of the panel and saves it to a variable. It's used later to automatically adjust the plot size
              ...
              fluidPage(
                fluidRow(
                  box(title = "Select dataset", width = 6, status = "primary", solidHeader = T, collapsible = T,
                      ...
                      selectInput("input_tbl_viewer_res_id", "Choose res_id", NULL),
      ...
      tabItem(tabName = "vis_jitterplot",
              box(title = "Select samples", status = "primary", solidHeader = T, collapsible = T, width = NULL,
                  selectInput("input_vis_jitterplot_completed_analyses", "Choose a res ID", NULL),
              ...
              box(title = "Jitter plot", status = "primary", solidHeader = T, width = NULL,
                  fluidRow(
                    column(width = 6,
                           selectInput("vis_jitterplot_agg_id", "Choose level of aggregation", NULL)),
                    column(width = 6,
              ...
              fluidRow(
                column(width = 6,
                       ...
                       box(title = "Select dataset", status = "primary", solidHeader = T, collapsible = T, width = NULL,
                           selectInput("input_3d_er_interactive_res_id", "Choose res_id", NULL),
              ...
              fluidRow(
                column(width = 4,
                       box(title = "Select dataset", status = "primary", solidHeader = T, width = NULL,
                           selectInput("input_interactive_lib_id", "Choose library", NULL),
                           selectInput("input_interactive_agg_id", "Choose level of aggregation", NULL),
                           h4("y axis"),
                           selectInput("input_interactive_y_type", "Choose type of value", c("count", "rank by counts", "enrichment")),
                           selectInput("input_interactive_y_res_id", "Choose res_id", NULL),
                           conditionalPanel(
                           ...
                           selectInput("input_interactive_x_res_id", "Choose res_id", NULL),
                           conditionalPanel(
      ...
      tabItem(tabName = "mono_heatmap",
              box(title = "Add entries to plot", status = "primary", solidHeader = T, collapsible = T, width = NULL,
                  selectInput("input_vis_mono_heatmap_completed_analyses", "Choose a res ID", NULL),
              ...
              box(title = "Heatmap", status = "primary", solidHeader = T, width = NULL,
                  fluidRow(
                    column(6, selectInput("vis_mono_heatmap_agg_id", "Choose monosynthon", NULL)),
                    column(6, sliderInput("input_vis_mono_heatmap_col_scale", "Color scale", min = 0.05, max = 10, value = 1, step = 0.05))
                  ),
...
addResourcePath("tempdir", getwd()) # I'm not sure this is still necessary
server <- function(input, output, session) {
  ...
  # Create lists for use in interactive pulldown lists: completed results, aggregation metadata, library metadata
  ...
  # Create various reactive values for use in interactive modules
  ...
  }) # Value box to display number of libraries
  ...
  }) # Value box to display number of screens performed
  ...
  }) # Value box to display number of targets screened
  ...
  }) # Value box to display number of analysis experiments performed
  ...
  }) # Pie chart to diplay usage of different resin types
  ...
  }) # Dot plot to display screening activity over time
  ...
  }) # Table to display library metadata
  ...
  }) # Triggered action: Adds a new entry to the library metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the library metadata table. Saves changes to file.
  ...
  }) # Triggered action: Reloads the library metadata based on what's saved on file.
  ...
  }) # Triggered action: Downloads library metadata.
  ...
  }) # Table to display combined library metadata.
  ...
  }) # Triggered action: Links edits to the metadata table to the reactive values (input) table.
  
  observeEvent(input$input_comb_lib_add_row, {
    rv$rv_input_comb_lib <- rv$rv_input_comb_lib %>%
      bind_rows(tibble(lib_id = 0, frac = 0))
  })  # Triggered action: Adds a new row to the reactive values (input) table.
  
  observeEvent(input$input_comb_lib_remove_row, {
    rv$rv_input_comb_lib <- rv$rv_input_comb_lib %>%
      head(-1)
  }) # Triggered action: Removes a row from the reactive values (input) table.
  ...
  }) # Triggered action: Adds a new entry to the combined library metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the combined library metadata table. Saves to file.
  ...
  observeEvent(input$reload_comb_lib_meta, {
    ...
    showNotification("Reloaded")
  }) # Triggered action: Reloads the combined library metadata table.
  ...
  output$output_comb_lib_meta_download <- downloadHandler("comb_lib_meta.csv", 
                                                     ...
                                                     contentType = "text/csv")  # Triggered action: Download the combined library metadata table.
  ...
  output$targ_meta_table <- DT::renderDataTable({
    DT::datatable(rv$rv_targ_meta %>%
                  ...
                  rownames = F, filter = "top", selection = "none",
                  class = "nowrap display")
  }) # Table to display target metadata.
  ...
  }) # Triggered action: Adds a new entry to the target metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the target metadata table. Saves to file.
  
  observeEvent(input$reload_targ_meta, {
    rv$rv_targ_meta <- file.path(config$project_dir, config$target_metadata) %>% fread() %>% as_tibble()
    showNotification("Reloaded")
  }) # Triggered action: Reloads the target metadata table.
  ...
  output$output_targ_meta_download <- downloadHandler("targ_meta.csv", 
                                                      ...
                                                      contentType = "text/csv")  # Triggered action: Downloads the target metadata table.
  ...
  output$resin_meta_table <- DT::renderDataTable({
    DT::datatable(rv$rv_resin_meta %>%
                  ...
                  rownames = F, filter = "top", selection = "none",
                  class = "nowrap display")
  }) # Display the resin metadata table.
  ...
  }) # Triggered action: Adds a new entry to the resin metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the resin metadata table. Saves to file.
  
  observeEvent(input$reload_resin_meta, {
    rv$rv_resin_meta <- file.path(config$project_dir, config$resin_metadata) %>% fread() %>% as_tibble()
    showNotification("Reloaded")
  }) # Triggered action: Reloads the resin metadata table.
  ...
  output$output_resin_meta_download <- downloadHandler("resin_meta.csv", 
                                                       ...
                                                       contentType = "text/csv") # Triggered action: Downloads the resin metadata table.
  ...
  output$scr_meta_table <- DT::renderDataTable({
    DT::datatable(rv$rv_scr_meta %>%
                  ...
                  rownames = F, filter = "top", selection = "none",
                  class = "nowrap display")
  }) # Display the screening metadata table.
  ...
  }) # Triggered action: Adds a new entry to the screening metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the screening metadata table. Saves to file.
  
  observeEvent(input$reload_scr_meta, {
    rv$rv_scr_meta <- file.path(config$project_dir, config$screen_metadata) %>% fread() %>% as_tibble()
    showNotification("Reloaded")
  }) # Triggered action: Reloads the screening metadata table.
  ...
  output$output_scr_meta_download <- downloadHandler("scr_meta.csv", 
                                                     ...
                                                     contentType = "text/csv") # Triggered action: Downloads the screening metadata table.
  
  output$samp_meta_table <- DT::renderDataTable({
    DT::datatable(rv$rv_samp_meta %>%
                    mutate(across(matches("_id"), as.factor)),
                  rownames = F, filter = "top", selection = "none")
  }) # Displays the sample metadata table.
  ...
  }) # Triggered action: Adds a new entry to the sample metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the sample metadata table. Saves to file.
  
  observeEvent(input$reload_samp_meta, {
    rv$rv_samp_meta <- file.path(config$project_dir, config$sample_metadata) %>% fread() %>% as_tibble()
    showNotification("Reloaded")
  }) # Triggered action: Reloads the sample metadata table.
  ...
  output$run_meta_table <- DT::renderDataTable({
    DT::datatable(rv$rv_run_meta %>%
                  ...
                  rownames = F, filter = "top", selection = "none",
                  class = "nowrap display")
  }) # Displays the sequencing run metadata table.
  ...
  }) # Triggered action: Adds a new entry to the sequencing run metadata table. Only a preview, doesn't actually modify any files.
  ...
  }) # Triggered action: Adds a new entry to the sequencing run metadata table. Saves to file.
  ...
  observeEvent(input$reload_run_meta, {
    ...
    showNotification("Reloaded")
  }) # Triggered action: Reloads the sequencing run metadata table.
  ...
  output$output_run_meta_download <- downloadHandler("run_meta.csv", 
                                                     ...
                                                     contentType = "text/csv") # Triggered action: Downloads the sequencing run metadata table.
  ...
  output$new_samples_table <- DT::renderDataTable({
    ...
    DT::datatable(fread(input$new_samples$datapath),
                  ...
                  class = "nowrap display")
  }) # Displays the input table (new rows to be potentially added to the sample metadata table).
  ...
  output$create_config_table <- DT::renderDataTable({
    ...
    DT::datatable(fread(input$config_upload$datapath),
                  rownames = F, selection = "none")
  }) # Displays the input table to be used to generate the configuration file (for counts generation).
  ...
  output$download_json <- downloadHandler("config_name.json", 
                                          ...
                                          contentType = "json") # Triggered action: Downloads the configuration file for counts generation
  ...
  }) # Triggered action: Updates the count file metadata based on the config file input table (and saves to file).
  ...
  }) # Persistently triggers: Updates choices for the create analysis table column selection.
  
  observeEvent(input$input_create_an_select_all_cols, {
    updateCheckboxGroupInput(session, "input_create_an_show_vars", choices = names(rv$rv_merged_meta), selected = names(rv$rv_merged_meta))
  }) # Triggered action: Selects all columns for display for the create analysis table.
  ...
  }) # Triggered action: Unselects all columns for display for the create analysis table.
  ...
  output$input_create_an_tbl <- DT::renderDataTable({
    DT::datatable(rv$rv_merged_meta[,input$input_create_an_show_vars, drop = FALSE] %>%
                  ...
                  options = list(dom = 'tp',
                                 pageLength = 4),
                  class = "nowrap display")
  }) # Displays the merged metadata table (from which samples are selected and named).
  ...
  observeEvent(input$reload_merged_meta_create_an, {
    ...
    showNotification("Reloaded")
  }) # Triggered action: Reloads the merged metadata table (from which samples are selected and named).

  merged_create_an_tbl_proxy <- dataTableProxy("input_create_an_tbl") # Proxy table is used for the interactive table display and row selection.
  
  observe({
    rv$rv_create_an_tbl_search_columns <- structure(names = colnames(rv$rv_merged_meta),
                                                    rep("", ncol(rv$rv_merged_meta)))
  }) # Persistently triggers: When the merged metadata table changes (is reloaded), the search filters for each column are reset.
  ...
  }) # Triggered action: When the user changes their search filters, these new values are saved in a reactive variable.
  ...
  }) # Triggered action: When the user changes their selection of columns to show, this script will readjust the search filters based on what is saved to the reactive variable.
  
  output$create_an_input_n_samp_selected <- renderText({
    paste0(length(input$input_create_an_tbl_rows_selected), " samples selected.")
  }) # Displays the number of samples selected to minimize chance for erroneous assignment of samples to nicknames.
  ...
  }) # Triggered action: Selects all samples.
  ...
  }) # Triggered action: Unselects all samples.
  ...
  }) # Triggered action: Takes the user input for samples and nickname and adds it to a reactive list.
  ...
  }) # Persistently triggers: Updates the dropdown menus for choice of target and control whenever a new entry is added to the reactive list.
  ...
  observeEvent(input$input_create_an_tbl_add_row, {
    ...
    rv$rv_create_an_tbl <- rv$rv_create_an_tbl %>%
      bind_rows(new_row)
  }) # Triggered action: Based on selection of target and control, a new analysis experiment entry is added to the create analysis table.
  ...
  output$create_an_input_tbl <- DT::renderDataTable({
    DT::datatable(rv$rv_create_an_tbl,
                  ...
                  class = "nowrap display",
                  selection = "none")
  }) # Displays the create analysis table.
  ...
  }) # Displays the input table for the control samples.
  ...
  output$run_an_simp_targ_table <- DT::renderDataTable({
    DT::datatable(rv$rv_run_an_simp_targ_tbl, rownames = F, width = "50%", selection = "none",
                  options = list(dom = 'tp',
                                 pageLength = 5,
                                 lengthMenu = c(5, 10, 15, 20)))
  }) # Displays the input table for the target samples.
  ...
  observeEvent(input$run_an_simp_ctrl_upload, {
    ...
    rv$rv_run_an_simp_ctrl_lst <- rv$rv_run_an_simp_ctrl_tbl %>%
      pull(ct_filename)
  }) # Triggered action: Loads the chosen table from file.
  ...
  }) # Triggered action: Finds the next unassigned result ID.
  ...
  observeEvent(input$run_an_simp_run, {
    ...
    if(rv$rv_run_an_simp_res_name %in% list.files(file.path(config$project_dir, config$result_metadata_location), recursive = F, full.names = F) %>% 
      ...
      # This step blocks other users of the app from taking the same result ID
      tibble() %>%
      ...
      # This code joins with the sample metadata and automatically assigns groups based on the combination of sample conditions
      submeta <- run_meta %>%
  ...
  output$run_an_adv_table <- DT::renderDataTable({
    DT::datatable(rv$rv_run_an_adv_tbl, rownames = F, width = "50%", selection = "none",
                  options = list(dom = 'tp',
                                 pageLength = 5,
                                 lengthMenu = c(5, 10, 15, 20)))
  }) # Displays the uploaded input table for the analysis.
  ...
  }) # Triggered action: Updates the displayed input table for the analysis based on the chosen file.
  ...
  }) # Persistently triggers: Makes sure the confidence interval is somewhere between 0 and 99.99.
  ...
  }) # Performs analysis experiments based on advanced input
  ...
  observe({
    updateSelectInput(session, "input_completed_analyses", "Choose a res ID", c("All", rv$rv_res_lst))
  }) # Persistently triggers: Updates list of completed analyses.
  ...
  }) # Triggered action: Displays the selected table based on the dropdown menu choice.
  ...
  output$res_meta_viewer <- DT::renderDataTable({
    ...
    DT::datatable(rv$rv_res_meta_viewer %>%
                  ...
                  rownames = F, filter = "top", selection = "none")
  }) # Displays the table of completed analyses.
  ...
  }) # Triggered action: Retrieves the requested compound structure based on user input.
  ...
  ) # Displays the structure of the requested compound.
  
  observeEvent(input$input_get_structure_single_cpd_smi_to_clip, {
    req(rv$rv_single_cpd_struct)
    Sys.setenv("CLIPR_ALLOW"=TRUE )
    clipr::write_clip(rv$rv_single_cpd_struct, allow_non_interactive = TRUE)
    showNotification("SMILES copied to clipboard")
  }) # Triggered action: Copies the SMILES structure of the requested compound to the user's clipboard.
  
  output$get_structure_table <- DT::renderDataTable({
    DT::datatable(rv$rv_cpd_structure, rownames = F, selection = "none",
                  options = list(dom = "tp"))
  }) # Displays the input table chosen by the user for retrieving compound structures.
  ...
  observeEvent(input$cpd_struct_upload, {
    ...
    rv$rv_cpd_structure <- rv$rv_cpd_structure %>%
      bind_rows(temp)
  }) # Triggered action: Loads the input table based on the chosen file.
  ...
  }) # Triggered action: Retrieves the structures of the requested compounds based on the input table.
  ...
  }) # Persistently triggers: Updates the dropdown list of result IDs.
  ...
  }) # A reactive value that updates based on the user's choice of result ID: available targes to choose from.
  
  observe({
    updateSelectInput(session, "input_tbl_viewer_targ_desc", choices = input_tbl_viewer_targ_choices())
  }) # Persistently triggers: Updates the dropdown list of targets based on the reactive value.
  ...
  }) # A reactive value that updates based on the user's choice of result ID: available controls to choose from.
  ...
  }) # A reactive value that updates based on the user's choice of result ID: available libraries to choose from.
  
  observe({
    updateSelectInput(session, "input_tbl_viewer_lib_id", choices = input_tbl_viewer_lib_choices())
  }) # Persistently triggers: Updates the dropdown list of libraries based on the reactive value.
  ...
  }) # Triggered action: Filters the displayed table based on user defined input (table specifying cycle IDs)
  
  observeEvent(input$visualize_tbl_viewer, {
    vis_tbl_viewer_notif <- showNotification("Gathering table...", duration = NULL)
    
    # Get the analysis metadata associated with the requested analysis
  ...
  }) # Triggered action: Pulls up the requested table with counts and erichment data (performed analyses)
  ...
  observe({
    updateSelectInput(session, "input_vis_jitterplot_completed_analyses", "Choose a res ID", c("All", rv$rv_res_lst))
  }) # Persistently triggers: Updates the dropdown list of result IDs.
  ...
  }) # Triggered action: Updates the reactive table of completed analyses based on what the user has selected.
  ...
  output$vis_jitterplot_completed_an_tbl <- DT::renderDataTable({
    ...
    DT::datatable(rv$rv_vis_jitterplot_completed_an_tbl %>%
                  ...
                  options = list(dom = 'tp',
                                 pageLength = 4),
                  class = "nowrap display")
  }) # Displays the table of completed analyses, filtered based on the dropdown menu.
  
  vis_jitterplot_an_tbl_proxy <- dataTableProxy("vis_jitterplot_completed_an_tbl") # Need a proxy table for interactive table.
  ...
  }) # Displays the number of analyses that are selected to minimize the chance for errors.
  ...
  }) # Triggered action: Adds the selected analyses to the dropdown menus.
  ...
  observe({
    ...
    updateSelectInput(session, "input_vis_jitterplot_color_choices", 
                      choices = rv$rv_vis_jitterplot_selected_samples_tbl$label)
  }) # Persistently triggers: Updates the dropdown menus based on any changes to the underlying reactive table (containing the added analyses).
  ...
  observeEvent(input$input_vis_jitterplot_add_entry, {
    ...
    # Make sure the specified nickname isn't already used
    ...
    # Read in the relevant count file names
    ...
    # Read in the counts for the target and control
    ...
    # Read in the metadata, starting with the highest: 1+2+3 trisynthon (agg_id = 7)
    ...
    # Iterate through the levels of aggregation (synthons)
    agg_ids <- as_tibble(fread(file.path(config$project_dir, config$aggregation_metadata))) %>% pull(agg_id)
    for(temp_agg_id in agg_ids) {
      # If the level is equal to the max (currently assumed to be 7), then skip the aggregation step
      ...
      # Otherwise aggregate based on the relevant cycle IDS
      else {
  ...
  }) # Triggered action: Adds the specified entry to the reactive table/list, which results in the displayed plot updating with the entry added
  ...
  }) # Persistently triggers: Updates the dropdown list of potential entries to remove from the plot (and from the reactive table/list).
  ...
  observeEvent(input$input_vis_jitterplot_remove_entry, {
    ...
    showNotification("Plot updated")
  }) # Triggered action: Removes the chosen entry from the reactive table/list.
  ...
  observeEvent(input$input_vis_jitterplot_remove_all, {
    ...
    updateSelectInput(session, "input_vis_jitterplot_remove_entry_choice", 
                      choices = unique(rv$rv_vis_jitterplot_vis_tbl[[1]]$x_lab))
    showNotification("Plot updated")
  }) # Triggered action: Removes all entries from the reactive table/list.
  
  observe({
    updateSelectInput(session, "vis_jitterplot_agg_id", "Choose level of aggregation", rv$rv_agg_lst)
  }) # Persistently triggers: Updates the list of aggregation levels if anything changes.
  ...
  }) # Persistently triggers: Updates the maximum value for the selectivity cutoff slider.
  ...
  output$output_vis_jitterplot_save_plot <- downloadHandler("vis_jitterplot.html",
                                                            ...
                                                            contentType = "html") # Triggered action: Downloads the jitter plot has an html file.
  ...
  output$output_vis_jitterplot_save_tbl <- downloadHandler("vis_jitterplot_tbl_save.csv",
                                                     ...
                                                     contentType = "text/csv") # Triggered action: Downloads the underlying table for the jitter plot.
  ...
  }) # Reactive value for the choice of libraries.
  
  observe({
    updateSelectInput(session, "input_3d_er_interactive_lib_id", choices = input_3d_er_interactive_lib_choices())
  }) # Persistently triggers: Updates the dropdown list of libraries.
  ...
  observeEvent(input$visualize_3d_er_sp_interactive, {
    ...
    # Read in the table of relevant metadata associated with the user-selected analysis.
    ...
    # Read in counts for the controls and targets
    temp_ctrl_lst <- temp_tbl %>% pull(ctrl_ct_lst) %>% str_split(", ") %>% unlist()
    temp_ctrl_ct <- as_tibble(fread(file.path(config$project_dir, config$data_count_location, temp_ctrl_lst[1])))
    if(length(temp_ctrl_lst) > 1) {
      for(i in 2:length(temp_ctrl_lst)) {
    ...
    # Read in enumerated structure metadata, if it hasn't already been loaded
    load_cpd_notif <- showNotification("Loading metadata...", duration = NULL)
    ...
    # Read in the enumerated calculated properties, if it hasn't already been loaded
    ...
    # Some code to adjust the range for the interactive sliders based on the dataset
    ...
    # Read in the relevant metadata (cycle IDs) and combine with the counts
    ...
    # Cycle ID mapping required for the "order by structural similarity" module
  ...
  }) # Triggered action: Visualizes the 3D box plot.
  ...
  }) # Persistently triggers: Automatically adjusts the point size based on the scaling factor chosen.
  ...
  }) # Renders the checkboxes that can be used to show/hide specific cycle IDs.
  ...
  }) # Triggered action: Hides/shows specific cycle IDs based on user input.
  ...
  }) # Triggered action: Resets the cycle ID filter (to show all cycle IDs).
  ...
  }) # Triggered action: Filters the compounds shown in the 3D box plot based on the user-defined cutoff.
  ...
  output$input_3d_er_sp_interactive_filter_mw_plot <- renderPlot({
    ...
    ggplot(temp, aes(x = emw, fill = filter_emw)) +
      ...
      guides(fill = "none")
  }, height = 200) # Displays the histogram of molecular weight distribution.
  ...
  output$input_3d_er_sp_interactive_filter_fsp3_plot <- renderPlot({
    ...
    ggplot(temp, aes(x = fsp3, fill = filter_fsp3)) +
      ...
      scale_fill_manual(values = c("light gray", "dark gray")) +
      guides(fill = "none")
  }, height = 200) # Displays the histogram of fraction of carbon atoms that are sp3 hybridized.
  ...
  output$input_3d_er_sp_interactive_filter_nrb_plot <- renderPlot({
    ...
    ggplot(temp, aes(x = nrb, fill = filter_nrb)) +
      ...
      scale_fill_manual(values = c("light gray", "dark gray")) +
      guides(fill = "none")
  }, height = 200) # Displays the histogram of number of rotatable bonds.
  ...
  output$input_3d_er_sp_interactive_filter_slogp_plot <- renderPlot({
    ...
    ggplot(temp, aes(x = slogp, fill = filter_slogp)) +
      ...
      scale_fill_manual(values = c("light gray", "dark gray")) +
      guides(fill = "none")
  }, height = 200) # Displays the histogram of calculated logP values.
  ...
  }) # Triggered action: Registers the cycle IDs of the clicked compound and also updates the selected structure (reactive value).
  ...
  ) # Displays the structure of the selected compound.
  ...
  }) # Displays some data associated with the selected compound as text.
  
  observeEvent(input$input_3d_er_sp_interactive_smi_to_clip, {
    req(rv$rv_3d_er_sp_interactive_selected_struct)
    clipr::write_clip(rv$rv_3d_er_sp_interactive_selected_struct, allow_non_interactive = TRUE)
    showNotification("SMILES copied to clipboard")
  }) # Triggered action: Saves the SMILES structure of the selected compound to the user's clipboard.
  ...
  observeEvent(input$input_3d_er_sp_interactive_reorder_bbs, {
    ...
    # For each cycle, calculate the Tanimoto similarity to every other building block in that cycle, using circular fingerprints
    cy1_mols <- bb_meta %>%
  ...
  }) # Triggered action: Reorders the building blocks based on similarity to the selected compound.
  ...
  }) # Triggered action: Resets the order of the building blocks to the default (numerical order of the cycle IDs).
  ...
  }) # Displays some data associated with the selected compound.
  ...
  }) # Displays the probability distribution of the expected enrichment ratio for the selected compound.
  ...
  output$output_3d_er_sp_interactive_save_plot <- downloadHandler("plot_name.html", 
                                                                  ...
                                                                  contentType = "html") # Triggered action: Downloads the 3D box plot as an html file.
  ...
  output$output_3d_er_sp_interactive_save_tbl <- downloadHandler("table_name.csv", 
                                                                 ...
                                                                 contentType = "text/csv") # Triggered action: Downloads the table associated with the 3D box plot.
  ...
  observe({
    updateSelectInput(session, "input_interactive_lib_id", choices = rv$rv_lib_lst)
  }) # Persistently triggers: Updates the dropdown list of libraries.
  ...
  input_interactive_y_samp_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_y_res_id, ".csv")))) %>%
      ...
      unlist() %>%
      unique()
  }) # Reactive value that keeps track of samples to choose from based on the selected result ID.
  
  observe({
    updateSelectInput(session, "input_interactive_y_samp_desc", choices = input_interactive_y_samp_choices())
  }) # Persistently triggers: Updates the selection of samples for the y axis.
  ...
  input_interactive_y_targ_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_y_res_id, ".csv")))) %>%
      filter(grepl(sprintf("lib%03d", as.numeric(unlist(str_split(input$input_interactive_lib_id, ": "))[1])), targ_ct_lst)) %>%
      pull(targ_description)
  }) # Reactive value that keeps track of targets to choose from based on the selected result ID for use for the y axis.
  
  observe({
    updateSelectInput(session, "input_interactive_y_targ_desc", choices = input_interactive_y_targ_choices())
  }) # Persistently triggers: Updates the selection of targets for the y axis.
  ...
  input_interactive_y_ctrl_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_y_res_id, ".csv")))) %>%
      ...
      pull(ctrl_description)
  }) # Reactive value that keeps track of controls to choose from based on the selected result ID for use for the y axis.
  
  observe({
    updateSelectInput(session, "input_interactive_y_ctrl_desc", choices = input_interactive_y_ctrl_choices())
  }) # Persistently triggers: Updates the selection of controls for the y axis.
  ...
  input_interactive_x_samp_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_x_res_id, ".csv")))) %>%
      ...
      unlist() %>%
      unique()
  }) # Reactive value that keeps track of samples to choose from based on the selected result ID for use for the x axis.
  
  observe({
    updateSelectInput(session, "input_interactive_x_samp_desc", choices = input_interactive_x_samp_choices())
  }) # Persistently triggers: Updates the selection of samples for the x axis.
  ...
  input_interactive_x_targ_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_x_res_id, ".csv")))) %>%
      filter(grepl(sprintf("lib%03d", as.numeric(unlist(str_split(input$input_interactive_lib_id, ": "))[1])), targ_ct_lst)) %>%
      pull(targ_description)
  }) # Reactive value that keeps track of targets to choose from based on the selected result ID for use for the x axis.
  
  observe({
    updateSelectInput(session, "input_interactive_x_targ_desc", choices = input_interactive_x_targ_choices())
  }) # Persistently triggers: Updates the selection of targets for the x axis.
  ...
  input_interactive_x_ctrl_choices <- reactive({
    ...
    as_tibble(fread(file.path(config$project_dir, config$result_metadata_location, paste0(input$input_interactive_x_res_id, ".csv")))) %>%
      ...
      pull(ctrl_description)
  }) # Reactive value that keeps track of controls to choose from based on the selected result ID for use for the x axis.
  
  observe({
    updateSelectInput(session, "input_interactive_x_ctrl_desc", choices = input_interactive_x_ctrl_choices())
  }) # Persistently triggers: Updates the selection of controls for the x axis.
  ...
  }) # Persistently triggers: Keeps track of which metadata to use based on the library and aggregation level chosen.
  ...
  }) # Persistently triggers: Determines what the y values of the plot will be based on the type of value chosen, the aggregation level, and the sample. This code is for when the type chosen is count or rank by counts.
  ...
  }) # Persistently triggers: If the library or result ID changes, then turn off the plot for now (otherwise the app can get slow or crash).
  ...
  }) # Persistently triggers: Determines what the y values of the plot will be based on the type of value chosen, the aggregation level, and the sample. This code is for when the type chosen is enrichments.
  ...
  }) # Persistently triggers: Determines what the x values of the plot will be based on the type of value chosen, the aggregation level, and the sample. This code is for when the type chosen is count or rank by counts.
  ...
  }) # Persistently triggers: Determines what the x values of the plot will be based on the type of value chosen, the aggregation level, and the sample. This code is for when the type chosen is enrichments.
  ...
  }) # Persistently triggers: Keeps track of which points, if any, should be colored differently based on user input.
  ...
  }) # Persistently triggers: Updates the dropdown list of result IDs to choose from.
  
  observe({
    updateSelectInput(session, "input_interactive_agg_id", "Choose level of aggregation", rv$rv_agg_lst)
  }) # Persistently triggers: Updates the dropdown list of aggregation levels to choose from.
  ...
  }) # Persistently triggers: Keeps track of what labels to use for the points in the plot (i.e., what is displayed with mouse hover).
  ...
  output$output_interactive_sp_save_plot_html <- downloadHandler("plot_name.html", 
                                                                 ...
                                                                 contentType = "html") # Triggered action: Downloads the plot as an html.
  ...
  output$output_interactive_sp_save_tbl <- downloadHandler("table_name.csv", 
                                                            ...
                                                            contentType = "text/csv") # Triggered action : Downloads the table associated with the plot.
  ...
  observe({
    updateSelectInput(session, "input_vis_mono_heatmap_completed_analyses", "Choose a res ID", c("All", rv$rv_res_lst))
  }) # Persistently triggers: Updates the dropdown list of result IDs to choose from.
  ...
  }) # Triggered action: Filters the displays analyses based on the result ID chosen from the dropdown menu.
  ...
  output$vis_mono_heatmap_completed_an_tbl <- DT::renderDataTable({
    ...
    DT::datatable(rv$rv_vis_mono_heatmap_completed_an_tbl %>%
                  ...
                  options = list(dom = 'tp',
                                 pageLength = 4),
                  class = "nowrap display")
  }) # Displays the table of completed analyses based on the selected result ID.
  ...
  observeEvent(input$input_vis_mono_heatmap_add_entry, {
    ...
    showNotification("Plot updated")
  }) # Triggered action: Adds the selected analysis (with chosen nickname) to the reactive value list, therby updating the plot with a new entry.
  ...
  }) # Persistently triggers: Updates the dropdown list of entries to choose from for removal.
  ...
  observeEvent(input$input_vis_mono_heatmap_remove_entry, {
    ...
    showNotification("Plot updated")
  }) # Triggered action: Removes the chosen entry from the reactive value list, thereby removing it from the plot.
  ...
  observeEvent(input$input_vis_mono_heatmap_remove_all, {
    ...
    updateSelectInput(session, "input_vis_mono_heatmap_remove_entry_choice", 
                      choices = unique(rv$rv_vis_mono_heatmap_vis_tbl[[1]]$y_lab))
    showNotification("Plot updated")
  }) # Triggered action: Removes all entries from the reactive value list.
  
  observe({
    updateSelectInput(session, "vis_mono_heatmap_agg_id", "Choose monosynthon", rv$rv_agg_lst[1:3])
  }) # Persistently triggers: Updates the levels of aggregation to choose from.
